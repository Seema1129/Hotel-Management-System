 ...
 * @author RAHUL
 */
public class loading extends javax.swing.JFrame {//import javax.swing.*;
                    ...
                    public void run(){ 
                        for(int i=0;i<=100;i++){
                            ...
                            if(jProgressBar1.getString().equals("50%"))
                                lbl3.setText("database connecting");
                            if(jProgressBar1.getString().equals("75%"))
                                lbl3.setText("luanching application");
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/losad.jpg"))); // NOI18N

        lbl3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lbl3.setForeground(new java.awt.Color(51, 102, 255));
        lbl3.setText("loading..");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {//SwingUtilities.invokeLater(new Runnable
            public void run() {
